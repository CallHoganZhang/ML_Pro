In this floder project, I want to do serveal experiment in order to help me improve understanding the theory of machine learing algorithm and thier application scenarios when programming.
